  ...
  return (
    <div className='parent'>
      {jobs.map(function(elem){
        return <Card image={elem.image} comp={elem.company} post={elem.role} type={elem.type} level={elem.level} posted={elem.posted} salary={elem.salary} location={elem.location} />
      })}
